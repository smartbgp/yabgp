...
class TestExtCommunity(unittest.TestCase):
    ...
    def test_parse_rt0(self):
        ...
        self.assertEqual(['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RT_0], '100:12')],
                         ext_community)
    ...
    def test_parse_rt1(self):
        ...
        self.assertEqual(['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RT_1], '10.10.10.10:12')],
                         ext_community)
    ...
    def test_parse_rt2(self):
        ...
        self.assertEqual(['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RT_2], '65537:12')],
                         ext_community)
    ...
    def test_parse_ro0(self):
        ...
        self.assertEqual(['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RO_0], '100:12')],
                         ext_community)
    ...
    def test_parse_ro1(self):
        ...
        self.assertEqual(['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RO_1], '10.10.10.10:12')],
                         ext_community)
    ...
    def test_parse_ro2(self):
        ...
        self.assertEqual(['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RO_2], '65537:12')],
                         ext_community)
    ...
    def test_parse_construct_flowspec_redirect_vrf(self):
        ...
        expected_value = ['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_REDIRECT_VRF], '4837:100')]
    ...
    def test_parse_construct_flowspec_redirect_nh(self):
        ...
        expected_value = ['%s:%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_REDIRECT_NH], '0.0.0.0', 0)]
    ...
    def test_parse_construct_tarffic_rate(self):
        ...
        expected_value = ['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_TRA_RATE], '100:6250000')]
    ...
    def test_parse_construct_transitive_opaque_encap(self):
        ...
        expected_value = ['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_ENCAP], 8)]
    ...
    def test_parse_construct_es_import(self):
        ...
        expected_value = [
            '%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_EVPN_ES_IMPORT], '00-11-22-33-44-55')
        ]
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
        self.assertEqual(community_hex, ExtCommunity.construct(community_list)[3:])
    ...
    def test_parse_construct_els_label(self):
        ...
        expected_value = ['%s:%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_EVPN_ESI_MPLS_LABEL], 1, 20)]
        self.assertEqual(community_hex, ExtCommunity.construct(community_list)[3:])
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
    ...
    def test_parse_construct_mac_mobil(self):
        ...
        expected_value = ['%s:%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_EVPN_MAC_MOBIL], 1, 500)]
        self.assertEqual(community_hex, ExtCommunity.construct(community_list)[3:])
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
    ...
    def test_parse_construct_evpn_route_mac(self):
        ...
        expected_value = ['%s:%s' % (bgp_cons.BGP_EXT_COM_STR_DICT[1539], '74-A0-2F-DE-FE-FB')]
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
