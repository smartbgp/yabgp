...
class TestCommunity(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        community = Community.parse(value=b'\x12\xe5&\xc9\xff\xff\x02\x9a')
        self.assertEqual(['4837:9929', 'BLACKHOLE'], community)
    ...
    def test_construct(self):
        ...
        community = Community.construct(value=['4837:1239', 'bLACKHOLE'])
        self.assertEqual(b'\xc0\x08\x08\x12\xe5\x04\xd7\xff\xff\x02\x9a', community)
